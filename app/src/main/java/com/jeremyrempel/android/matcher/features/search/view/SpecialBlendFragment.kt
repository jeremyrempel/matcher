...
import com.jeremyrempel.android.matcher.features.search.presentation.SpecialBlendPresentor
import io.reactivex.android.schedulers.AndroidSchedulers
import io.reactivex.disposables.CompositeDisposable
import timber.log.Timber
import javax.inject.Inject

class SpecialBlendFragment @Inject constructor(
    private val presenter: SpecialBlendPresentor
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<RecyclerView>(R.id.recycler).apply {
            ...
            adapter = this@SpecialBlendFragment.listAdapter
        }
    }
